...
class HighPerformanceS3Downloader:
    ...
    def _process_worker(
        ...
        # Instead of using asyncio/aioboto3 which has compatibility issues,
        # we'll use ThreadPoolExecutor which is more reliable
            ...
            for attempt in range(self.max_attempts):
                try:
                    ...
                    config = boto3.s3.transfer.TransferConfig(
                        ...
                        use_threads=True,
                        max_concurrency=2  # Use limited concurrency within each thread
                    )
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=self.concurrency_per_process) as executor:
